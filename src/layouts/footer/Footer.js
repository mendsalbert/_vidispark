          ...
          <div className="footer-column footer-column-large">
            <div className="footer-widget">
              ...
              <div className="footer-text">
                <p>
                  We envision Vidispark as a vibrant platform that empowers
                  artists to showcase and sell their creations directly to their
                  passionate supporters. Our platform welcomes a diverse range
                  of art forms, including visual art, music, videos, and various
                  other mediums. By providing a dynamic marketplace, we enable
                  artists to connect with their audience, gain recognition, and
                  monetize their talents. Vidispark serves as a catalyst for
                  artistic expression, fostering a community where creativity
                  thrives and artists can thrive alongside their dedicated
                  supporters.
                </p>
              </div>
