...
function MyApp({ Component, pageProps }) {
  ...
  useEffect(async () => {
    ...
    We regret to inform you that we are currently experiencing a technical issue that is impacting our services. Our team is working diligently to resolve this matter as quickly as possible. We apologize for any inconvenience caused and appreciate your patience and understanding.

    Rest assured that we are doing everything we can to get things back to normal. We will keep you updated on the progress and notify you as soon as the issue is resolved.
